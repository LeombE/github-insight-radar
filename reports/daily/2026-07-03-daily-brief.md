...
- What it is: MauroDruwel/NIMStats is a HTML project for Data Scientist: 📊 Automated hourly benchmarks for 20+ NVIDIA NIM models — interactive dashboard, zero infra, self-hostable. Open-source & community-driven.
- Angle: Useful for model, benchmark, notebook, or experiment review.
- Score: 47.26
...
## Data Files
- Raw API JSON: `data/raw/2026-07-03-github-api-raw.json`
- Daily projects JSON: `data/processed/2026-07-03-github-insight-projects.json`
- Daily projects CSV: `data/processed/2026-07-03-github-insight-projects.csv`
