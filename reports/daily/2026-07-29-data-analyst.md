# Data Analyst GitHub Insight - 2026-07-29

Generated at: `2026-07-29T06:45:07+00:00`
Mode: `live`
...
| 5 | [Lithiumgreentek/power-bi-design-vault](https://github.com/Lithiumgreentek/power-bi-design-vault) | 80.50 | Watch this week | Unknown | no README evidence, installation unclear, usage examples unclear, no license |
...
| 7 | [goodmorningbeautyful-lab/PhonePe-Pulse-Analyzer](https://github.com/goodmorningbeautyful-lab/PhonePe-Pulse-Analyzer) | 80.50 | Watch this week | Unknown | no README evidence, installation unclear, usage examples unclear, no license |
| 8 | [ZingerLittleBee/ServerBee](https://github.com/ZingerLittleBee/ServerBee) | 80.00 | Try today | Advanced | usage examples unclear |
...
| 13 | [luovicter-collab/bilibinggo](https://github.com/luovicter-collab/bilibinggo) | 61.00 | Use as portfolio reference | Intermediate | no license |
| 14 | [bruin-data/bruin](https://github.com/bruin-data/bruin) | 55.50 | Watch this week | Advanced | no README evidence, installation unclear, usage examples unclear |
| 15 | [graphene-data/graphene](https://github.com/graphene-data/graphene) | 55.50 | Skip for now | Unknown | no README evidence, installation unclear, usage examples unclear, no license, many open issues relative to stars |
...
- Evidence: Stars: 75823; Forks: 14387; Language: TypeScript; License: AGPL-3.0; README length: 0; Topics: alerting, analytics, business-intelligence, dashboard, data-visualization, elasticsearch, go, grafana, hacktoberfest, influxdb, metrics, monitoring, mysql, postgres, prometheus
- Confidence: low
...
- Evidence: Stars: 48414; Forks: 6690; Language: Clojure; License: NOASSERTION; README length: 0; Topics: analytics, bi, business-intelligence, businessintelligence, clojure, dashboard, data, data-analysis, data-visualization, database, metabase, mysql, postgres, postgresql, reporting, slack, sql-editor, visualization
- Confidence: low
...
- Evidence: Stars: 74031; Forks: 17970; Language: Python; License: Apache-2.0; README length: 0; Topics: analytics, apache, apache-superset, asf, bi, business-analytics, business-intelligence, data-analysis, data-analytics, data-engineering, data-science, data-visualization, data-viz, flask, python, react, sql-editor, superset
- Confidence: low
...
- Summary: ZingerLittleBee/ServerBee is a Rust project for Data Analyst: Lightweight VPS monitoring with agent + server + web dashboard. Rust + React monorepo.
- Why it matters: It maps to Data Analyst needs with an evidence-based score of 83.13.
- Practical use cases: Build a metrics or dashboard case study, Practice data cleaning and reporting, Extract a portfolio workflow
- Portfolio idea: Turn ServerBee into a concise portfolio note with problem, evidence, implementation idea, output, and limitations.
- Evidence: Stars: 332; Forks: 17; Language: Rust; License: AGPL-3.0; README length: 7922; Topics: agent, axum, dashboard, monitoring, probe, react, rust, self-hosted, serverbee, sqlite, system-monitor, typescript, vps, websocket
- Confidence: high
...
- Evidence: Stars: 24272; Forks: 4235; Language: Java; License: GPL-3.0; README length: 0; Topics: apache-doris, business-intelligence, data-analysis, data-visualization, echarts, kettle, superset, tableau
- Confidence: low
...
- Evidence: Stars: 21728; Forks: 5280; Language: Python; License: NOASSERTION; README length: 0; Topics: bigquery, change-data-capture, data, data-analysis, data-collection, data-engineering, data-integration, data-pipeline, elt, etl, java, mssql, mysql, pipeline, postgresql, python, redshift, s3, self-hosted, snowflake
- Confidence: low
...
- Why it matters: It maps to Data Analyst needs with an evidence-based score of 53.02.
- Practical use cases: Build a metrics or dashboard case study, Practice data cleaning and reporting, Extract a portfolio workflow
...
- Evidence: Stars: 593; Forks: 65; Language: Python; License: MIT; README length: 0; Topics: asset-management, data-analysis, data-visualization, investment-analysis, performance-attribution, portfolio-optimization, portfolio-risk-management, python, quantitative-finance
- Confidence: low

### luovicter-collab/bilibinggo
- Summary: luovicter-collab/bilibinggo is a Python project for General User: Binggo · 开源 B站抽奖助手（哔哩哔哩抽奖工具）— 本机自动发现活动，一键/三连参与。
- Why it matters: It maps to General User needs with an evidence-based score of 76.66.
- Practical use cases: Evaluate practical utility, Try a small workflow, Decide whether to adopt, save, or skip
- Portfolio idea: Turn bilibinggo into a concise portfolio note with problem, evidence, implementation idea, output, and limitations.
- Evidence: Stars: 203; Forks: 25; Language: Python; License: unavailable; README length: 10265; Topics: automation, bilibili, bilibili-live-tools, dashboard, giveaway, local-first-software, lottery, macos, open-source, privacy-first, windows
- Confidence: high

### bruin-data/bruin
- Summary: bruin-data/bruin is a Go project for Data Analyst: Build data pipelines with SQL and Python, ingest data from different sources, add quality checks, and build end-to-end flows.
- Why it matters: It maps to Data Analyst needs with an evidence-based score of 52.01.
- Practical use cases: Build a metrics or dashboard case study, Practice data cleaning and reporting, Extract a portfolio workflow
- Portfolio idea: Turn bruin into a concise portfolio note with problem, evidence, implementation idea, output, and limitations.
- Evidence: Stars: 1654; Forks: 86; Language: Go; License: Apache-2.0; README length: 0; Topics: analytics, bigquery, data-analysis, data-ingestion, data-modeling, data-pipelines, data-platform, data-transformation, python, snowflake, sql
- Confidence: low
...
- Why it matters: It maps to Data Analyst needs with an evidence-based score of 41.61.
- Practical use cases: Build a metrics or dashboard case study, Practice data cleaning and reporting, Extract a portfolio workflow
...
- Evidence: Stars: 51; Forks: 6; Language: TypeScript; License: unavailable; README length: 0; Topics: analytics, dashboards, data-analysis, data-analytics, data-visualization, semantic-modeling
- Confidence: low
