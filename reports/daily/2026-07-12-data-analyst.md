...
- Why it matters: It maps to General User needs with an evidence-based score of 54.43.
...
- Evidence: Stars: 153; Forks: 30; Language: JavaScript; License: MIT; README length: 0; Topics: agents, ai-tools, anthropic, awesome-claude-code, chinese, chromadb, claude, claude-cli-checkpoints, claude-code-cli, claude-skills, dashboard, diff, embeddings, llm, memory-engine, nodejs, npm, sqlite
- Confidence: low
